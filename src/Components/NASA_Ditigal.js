    ...
    return (
        <div className="content-container">
            ...
            <p className=" pl-16">
                ...
                No doubt, you have digital pain points, problems, and processes you'd love to make better. We work directly with you (and your users) to design, test, and build
                digital solutions that create the best possible outcomes for everyone involved. Our engagement times can be as little as a week to several months, depending on your
                need. Our team does not own systems, apps or websites. You do. 
                
                We work with you to make them the best experiences for your users possible. Working with us is fun, easy, and solves the digital problems you have in the most 
                effective and efficient means possible. We use the best digital practices and process to quickly delivervalue to your user base. We leverage your subject matter expertise so that your users
                have the best solutions that solve their problems. 
                
                Partner with us, and discover what you can accomplish in very little time. 
            </p>
            ...
            <p className="pl-16">
                We'll ship the product. Your users will see the value of how this process rapidly delivered value and ROI. (Typically a few weeks)
            </p>
